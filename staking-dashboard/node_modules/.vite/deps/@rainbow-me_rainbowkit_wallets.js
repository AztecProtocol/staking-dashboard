"use client";
import "./chunk-HANO3NFW.js";
import {
  coinbaseWallet,
  metaMask,
  safe,
  walletConnect
} from "./chunk-XSCFJR47.js";
import "./chunk-6VZL3XSP.js";
import "./chunk-AVNDHI5S.js";
import "./chunk-B7YNZH7Q.js";
import "./chunk-ANJCMEYS.js";
import {
  createConnector,
  injected
} from "./chunk-6JLM2UY7.js";
import "./chunk-TTNRIITN.js";
import "./chunk-FJOPNHGX.js";
import "./chunk-COXGZ7LA.js";
import "./chunk-3BHFJ7RT.js";
import "./chunk-EEADHRRE.js";
import "./chunk-HOYDTBMS.js";
import "./chunk-KJSCQHNT.js";
import "./chunk-JDKAWZPR.js";
import "./chunk-47UJDEO3.js";
import "./chunk-KIQAQYNI.js";
import "./chunk-TPVIZ6QV.js";
import "./chunk-IH4OW7UQ.js";
import "./chunk-UQ7B6RR3.js";
import "./chunk-ZJ4VJPSR.js";
import "./chunk-NSDO7JQ5.js";
import "./chunk-VEQIG2YB.js";
import "./chunk-JN7TQJPZ.js";
import "./chunk-3NIYQQ3T.js";
import "./chunk-VKJLEXYM.js";
import "./chunk-6LDMKKWZ.js";
...
var zealWallet = ({
  ...
  return {
    ...
    name: "Zeal",
    rdns: "app.zeal",
    iconUrl: async () => (await import("./zealWallet-I6PCJZVZ-VCL6DTVZ.js")).default,
    iconBackground: "#fff0",
    iconAccent: "#00FFFF",
    downloadUrls: {
...
var zerionWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./zerionWallet-YD6NMGW7-YQJ76H2C.js")).default,
    iconAccent: "#2962ef",
...
var xdefiWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./xdefiWallet-ORZSAYJI-2IIPN3YY.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var tokenPocketWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./tokenPocketWallet-U7KE4MQK-JYA36RFO.js")).default,
...
var tokenaryWallet = () => ({
  id: "tokenary",
  name: "Tokenary",
  iconUrl: async () => (await import("./tokenaryWallet-FHKZ7EWH-MOVBE6NB.js")).default,
...
var trustWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./trustWallet-42DZQQWY-AK3VTFB6.js")).default,
...
var uniswapWallet = ({
  ...
  id: "uniswap",
  name: "Uniswap Wallet",
  iconUrl: async () => (await import("./uniswapWallet-VSBIGDAA-7ZLMCZTL.js")).default,
...
var valoraWallet = ({
  ...
  id: "valora",
  name: "Valora",
  iconUrl: async () => (await import("./valoraWallet-EZ7AFD7R-UKLSNVJ7.js")).default,
  iconBackground: "#FFFFFF",
  downloadUrls: {
...
var wigwamWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./wigwamWallet-JFVOU3BA-H3TQGG7S.js")).default,
    downloadUrls: {
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-YHWKVTDY-YQGRQXNR.js")).default,
...
var xPortalWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./xPortalWallet-22MVKNGC-5CZRWU5Y.js")).default,
    iconAccent: "#23f7dd",
...
var roninWallet = ({
  ...
  return {
    id: "ronin",
    name: "Ronin Wallet",
    iconUrl: async () => (await import("./roninWallet-WPRP36LJ-YKW6QRF4.js")).default,
    iconBackground: "#ffffff",
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-5MNKTR5Z-S7MX7DQZ.js")).default,
  installed: (
...
var safeheronWallet = () => ({
  ...
  iconUrl: async () => (await import("./safeheronWallet-BO2A3JEH-GHF6D5UW.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
function seifWallet() {
  ...
  return {
    ...
    iconUrl: async () => (await import("./seifWallet-XRBCFDYI-A5K3RHM2.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var subWallet = ({
  ...
  return {
    ...
    name: "SubWallet",
    rdns: "app.subwallet",
    iconUrl: async () => (await import("./subWallet-MELG3LVN-J7SPLSBX.js")).default,
    iconBackground: "#fff",
...
var safepalWallet = ({
  ...
  return {
    id: "safepal",
    name: "SafePal Wallet",
    iconUrl: async () => (await import("./safepalWallet-7MFIBUI7-3IBW5LXD.js")).default,
    // Note that we never resolve `installed` to `false` because the
...
var tahoWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./tahoWallet-K4GKE2XM-WU5JXULU.js")).default,
    downloadUrls: {
...
var talismanWallet = () => ({
  ...
  name: "Talisman",
  rdns: "xyz.talisman",
  iconUrl: async () => (await import("./talismanWallet-CHXA2CKU-FIWJP3IE.js")).default,
  iconBackground: "#fff",
  installed: hasInjectedProvider({
...
var omniWallet = ({
  ...
  id: "omni",
  name: "Omni",
  iconUrl: async () => (await import("./omniWallet-YCK6QV5V-VSGBK7WZ.js")).default,
  iconBackground: "#000",
  downloadUrls: {
...
var oneKeyWallet = () => {
  return {
    ...
    iconAccent: "#00B812",
    iconBackground: "#fff",
    iconUrl: async () => (await import("./oneKeyWallet-W2CXILHF-LZ5GX3GI.js")).default,
...
var oneInchWallet = ({
  ...
  id: "1inch",
  name: "1inch Wallet",
  iconUrl: async () => (await import("./oneInchWallet-H7WWLHNC-C56JVSFG.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var paraSwapWallet = ({
  ...
  iconUrl: async () => (await import("./paraSwapWallet-BOGFGWWL-M2KXFN46.js")).default,
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-O26YNBMX-BQRIGTZM.js")).default,
...
var rabbyWallet = () => ({
  id: "rabby",
  name: "Rabby Wallet",
  iconUrl: async () => (await import("./rabbyWallet-GFVPHCTK-BZ4V7O4W.js")).default,
  rdns: "io.rabby",
...
var phantomWallet = () => {
  return {
    ...
    name: "Phantom",
    rdns: "app.phantom",
    iconUrl: async () => (await import("./phantomWallet-5SZPLGFE-UVHCOEEI.js")).default,
...
var ramperWallet = () => {
  ...
  return {
    id: "ramper",
    name: "Ramper Wallet",
    iconUrl: async () => (await import("./ramperWallet-MHVP6PEA-VZOEGZ3O.js")).default,
...
var mewWallet = ({
  ...
  return {
    id: "mew",
    name: "MEW wallet",
    iconUrl: async () => (await import("./mewWallet-IF2URER6-D5EB4AD6.js")).default,
    iconBackground: "#fff",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-SITXT2FV-D25UHN55.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var iopayWallet = ({
  ...
  id: "iopay",
  name: "ioPay Wallet",
  iconUrl: async () => (await import("./iopayWallet-C3FKJSQR-LF6GEOSI.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var ledgerWallet = ({
  ...
  iconAccent: "#000",
  name: "Ledger",
  iconUrl: async () => (await import("./ledgerWallet-ENWBDTSW-2YQM2SXR.js")).default,
  downloadUrls: {
...
var magicEdenWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./magicEden-ZVBTVRJ3-4T2PX7WH.js")).default,
...
var nestWallet = () => ({
  ...
  name: "Nest",
  rdns: "xyz.nestwallet",
  iconUrl: async () => (await import("./nestWallet-GDWDVMGN-KY6LFFVQ.js")).default,
  iconBackground: "#fff0",
...
var oktoWallet = ({
  ...
  id: "Okto",
  name: "Okto",
  iconUrl: async () => (await import("./oktoWallet-PGQ2ACED-AMXR3PMP.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var okxWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./okxWallet-QOP2OIPE-EZXEP77I.js")).default,
    iconAccent: "#000",
    iconBackground: "#000",
    downloadUrls: {
...
var frontierWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./frontierWallet-DDIDVVSH-MELSU25S.js")).default,
...
var frameWallet = () => ({
  ...
  iconUrl: async () => (await import("./frameWallet-HPFOBTAW-PG2DIDZN.js")).default,
...
var injectedWallet = () => ({
  id: "injected",
  name: "Browser Wallet",
  iconUrl: async () => (await import("./injectedWallet-AWJSZPMG-BFDUAMFH.js")).default,
  iconBackground: "#fff",
  createConnector: getInjectedConnector({})
});
...
var kaikasWallet = ({
  ...
  return {
    id: "kaikas",
    name: "Kaikas Wallet",
    iconUrl: async () => (await import("./kaikasWallet-2BPDM2G7-QQPHUTLP.js")).default,
...
var krakenWallet = ({
  ...
  id: "kraken",
  name: "Kraken Wallet",
  iconUrl: async () => (await import("./krakenWallet-J63GG4YB-GWNT5WOP.js")).default,
  iconBackground: "#FFD8EA",
  downloadUrls: {
...
var kresusWallet = ({
  ...
  id: "kresus-wallet",
  name: "Kresus Wallet",
  iconUrl: async () => (await import("./kresusWallet-NGTYX3DA-SNMOMYOV.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var gateWallet = ({
  ...
  return {
    ...
    name: "Gate Wallet",
    rdns: "io.gate.wallet",
    iconUrl: async () => (await import("./gateWallet-OZEAMFDV-FZABJTUD.js")).default,
    iconAccent: "#fff",
    iconBackground: "#fff",
    downloadUrls: {
...
var kaiaWallet = ({
  ...
  return {
    id: "kaia",
    name: "Kaia Wallet",
    iconUrl: async () => (await import("./kaiaWallet-GBL7VILA-SO3ZNYJ3.js")).default,
...
var zilPayWallet = ({
  ...
  return {
    ...
    name: "ZilPay",
    rdns: "io.zilpay",
    iconUrl: async () => (await import("./zilPayWallet-QHL2XHCV-QGJAULQL.js")).default,
    iconBackground: "#ffffff",
    downloadUrls: {
...
var compassWallet = () => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./compassWallet-KKRQGZSG-DOGV52W6.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var coreWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./coreWallet-IZI2OUBR-J2CE6D4A.js")).default,
...
var dawnWallet = () => ({
  id: "dawn",
  name: "Dawn",
  iconUrl: async () => (await import("./dawnWallet-APT3XIRF-T2EFH43X.js")).default,
...
var desigWallet = () => {
  return {
    id: "desig",
    name: "Desig Wallet",
    iconUrl: async () => (await import("./desigWallet-KCDE26CB-WPMNVV5V.js")).default,
    iconBackground: "#ffffff",
...
var enkryptWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./enkryptWallet-BO2P32DY-JOQWHYE6.js")).default,
    iconBackground: "#FFFFFF",
    downloadUrls: {
...
var foxWallet = ({
  ...
  return {
    id: "foxwallet",
    name: "FoxWallet",
    iconUrl: async () => (await import("./foxWallet-WTBDNPXQ-UWG7IWOM.js")).default,
    iconBackground: "#fff",
    downloadUrls: {
...
var imTokenWallet = ({
  ...
  id: "imToken",
  name: "imToken",
  iconUrl: async () => (await import("./imTokenWallet-G47XZEL3-QIQCNZPH.js")).default,
...
var bitverseWallet = ({
  ...
  iconUrl: async () => (await import("./bitverseWallet-6Z5UWYJ3-QM4WJEZW.js")).default,
...
var bybitWallet = ({
  ...
  return {
    ...
    name: "Bybit Wallet",
    rdns: "com.bybit",
    iconUrl: async () => (await import("./bybitWallet-UHSPZQ56-BQRST22H.js")).default,
...
var bloomWallet = ({
  ...
  iconBackground: "#000",
  iconAccent: "#000",
  iconUrl: async () => (await import("./bloomWallet-MPN76HHH-IYQKXK7L.js")).default,
  downloadUrls: {
...
var braveWallet = () => ({
  ...
  iconUrl: async () => (await import("./braveWallet-SZMR4SAC-36W5JBL3.js")).default,
  iconBackground: "#fff",
...
var clvWallet = ({
  ...
  return {
    id: "clv",
    name: "CLV",
    iconUrl: async () => (await import("./clvWallet-TOXQAN2F-57QWHWXT.js")).default,
    iconBackground: "#fff",
    iconAccent: "#BDFDE2",
...
var bitskiWallet = () => ({
  ...
  iconUrl: async () => (await import("./bitskiWallet-4GG55SWQ-EQBPDWZV.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var coin98Wallet = ({
  ...
  return {
    id: "coin98",
    name: "Coin98 Wallet",
    iconUrl: async () => (await import("./coin98Wallet-LBBSGIZG-3BM5QFCN.js")).default,
...
var coinbaseWallet2 = ({ appName, appIcon }) => {
  ...
  return {
    ...
    iconUrl: async () => (await import("./coinbaseWallet-OKXU3TRC-WY4DZMBD.js")).default,
    iconAccent: "#2c5ff6",
...
var argentWallet = ({
  ...
  id: "argent",
  name: "Argent",
  iconUrl: async () => (await import("./argentWallet-YEEWCMC4-HQWHTLUV.js")).default,
  iconBackground: "#fff",
  downloadUrls: {
...
var bestWallet = ({
  ...
  id: "bestWallet",
  name: "Best Wallet",
  iconUrl: async () => (await import("./bestWallet-YV3FJ7MS-2N45KJDQ.js")).default,
...
var berasigWallet = ({
  ...
  return {
    ...
    name: "BeraSig",
    rdns: "app.berasig",
    iconUrl: async () => (await import("./berasigWallet-S6GSU4W4-XCHOK3CD.js")).default,
    iconBackground: "#ffffff",
...
var backpackWallet = () => {
  return {
    ...
    iconUrl: async () => (await import("./backpackWallet-CKSJ4VI6-ERDKCZOG.js")).default,
...
var bifrostWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./bifrostWallet-QCRWPXE2-U5S556SH.js")).default,
    iconBackground: "#fff",
...
var binanceWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./binanceWallet-RCEFB436-WOCT2I34.js")).default,
    iconBackground: "#000000",
...
var bitgetWallet = ({
  ...
  return {
    ...
    iconUrl: async () => (await import("./bitgetWallet-F7U5Y4MR-PGIVEIKS.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
