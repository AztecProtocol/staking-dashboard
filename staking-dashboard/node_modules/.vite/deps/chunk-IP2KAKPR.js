...
var ICONS = {
  add: async () => (await import("./add-2JRMA26X.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-EHPOTTOZ.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-GUG7ZJOG.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-UBJJ5BPA.js")).appStoreSvg,
  apple: async () => (await import("./apple-4QOMYNYH.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-LBSUFSBT.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-WGXITXBK.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-IYQC7OLO.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-DCLE6VVK.js")).arrowTopSvg,
  bank: async () => (await import("./bank-56XQYKD6.js")).bankSvg,
  browser: async () => (await import("./browser-J3PCIARQ.js")).browserSvg,
  card: async () => (await import("./card-3Q6Z7JLH.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-ELWURLV5.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-L2OZKJ7I.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-7EXD4GEH.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-BMCKIRBA.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-MIIL2JWB.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-6THGWV4Y.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-TXZXUQYS.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-MIENW43N.js")).clockSvg,
  close: async () => (await import("./close-46DOX5WO.js")).closeSvg,
  compass: async () => (await import("./compass-BRUJQHBI.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-NCVL3EPL.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-KR3SZN5V.js")).copySvg,
  cursor: async () => (await import("./cursor-3BS4HWI5.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-ELPNHJL6.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-G4JH4SLN.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-MQ6MN7KQ.js")).disconnectSvg,
  discord: async () => (await import("./discord-AFSFT2AM.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-34OKWZXE.js")).etherscanSvg,
  extension: async () => (await import("./extension-IJNKNFPI.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CIRTW646.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-M2NHWSZO.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-2GQ5ZV5L.js")).farcasterSvg,
  filters: async () => (await import("./filters-MZNDCYOB.js")).filtersSvg,
  github: async () => (await import("./github-5BOKPNKT.js")).githubSvg,
  google: async () => (await import("./google-T7NVF2UI.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-T5SEC6IN.js")).helpCircleSvg,
  image: async () => (await import("./image-GAMAR7C2.js")).imageSvg,
  id: async () => (await import("./id-MVGVU6SV.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-OQNAY6UJ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-DLYRKWXJ.js")).lightbulbSvg,
  mail: async () => (await import("./mail-4C2FH6E2.js")).mailSvg,
  mobile: async () => (await import("./mobile-Q4RGQXE4.js")).mobileSvg,
  more: async () => (await import("./more-MBBOSDIL.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-KX7GYXRS.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-HE4R4KJZ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-NRJIIPEB.js")).offSvg,
  playStore: async () => (await import("./play-store-2TKU3O4X.js")).playStoreSvg,
  plus: async () => (await import("./plus-Q3J4HJIQ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-GKBSZY36.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-TJEJ2STW.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-J6V3222T.js")).refreshSvg,
  search: async () => (await import("./search-4ABYS5MA.js")).searchSvg,
  send: async () => (await import("./send-QFE2F3FP.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-XQRVP3FT.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-MX723M6H.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-DUYTIASE.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-LWKXPLID.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-57K5NI6O.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-C7RBJS6C.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-TEFSNMMF.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-6YHV4LBK.js")).twitchSvg,
  twitter: async () => (await import("./x-BCIJO7YB.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-5BNOO2XU.js")).twitterIconSvg,
  verify: async () => (await import("./verify-6QSYYR2Y.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-CBZGUFG7.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-X5IC2UDM.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-6XYBHVYS.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-6XYBHVYS.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-6XYBHVYS.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-KWBINFWE.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-34NZ3GXJ.js")).warningCircleSvg,
  x: async () => (await import("./x-BCIJO7YB.js")).xSvg,
  info: async () => (await import("./info-AFRHOBLV.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-U2C55QIU.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-NTH2XUXF.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IP2KAKPR.js.map
